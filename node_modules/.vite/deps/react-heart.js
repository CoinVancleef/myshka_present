...
var Svg = styled_components_browser_esm_default.svg`cursor: pointer;${(props) => {
  if (props.animationTrigger === "hover")
    ...
    return `transition: transform ${props.animationDuration}s; &:hover { transform: scale(${props.animationScale});} &:active { transform: scale(${Math.pow(props.animationScale, 2)});}`;
}});}`;
Heart.propTypes = {
...
// dep:react-heart
var react_heart_default = Heart;
export {
  react_heart_default as default
};
/*
object-assign
(c) Sindre Sorhus
